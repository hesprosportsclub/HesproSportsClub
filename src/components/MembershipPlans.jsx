  ...
  return (
    <section id="membership-plan" className="py-16 bg-[#1F1F1F] text-[#D8DBD5]">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12 text-[#6EC1E4]">Membership Plans</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <motion.div
              ...
              className="bg-[#2E2E2E] p-6 rounded-lg border border-[#6EC1E4] shadow-lg text-center"
            >
              <h3 className="text-2xl font-bold mb-4 text-[#6EC1E4]">{plan.title}</h3>
